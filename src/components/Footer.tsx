      ...
      <div className="container-narrow section-padding">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
          ...
          <div className="space-y-4">
            <img src={logo} alt="Projekty Budowy - Adam Adrianowski" className="h-16 w-auto" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              <a href="tel:+48668258364" className="flex items-center gap-3 text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors">
                <Phone className="w-4 h-4 shrink-0" />
                +48 668 258 364
              </a>
              <a href="mailto:projektybudowy@gmail.com" className="flex items-center gap-3 text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors">
                <Mail className="w-4 h-4 shrink-0" />
                projektybudowy@gmail.com
              </a>
              <div className="flex items-start gap-3 text-sm text-primary-foreground/70">
                <MapPin className="w-4 h-4 shrink-0 mt-0.5" />
                <span>Babice 104, 95-083 Lutomiersk, woj. łódzkie</span>
              </div>
            </div>
          </div>
        </div>
